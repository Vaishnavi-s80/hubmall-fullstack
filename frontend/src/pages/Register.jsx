...
import { User, Lock, Mail, ShoppingBag } from 'lucide-react';
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full bg-white p-8 rounded-3xl border border-slate-200 shadow-xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-bold text-slate-900">Create HubMall Account</h2>
          <p className="text-sm text-slate-500">Join as a shopper or open your own vendor store</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-bold uppercase text-slate-600 mb-1.5">Account Role</label>
